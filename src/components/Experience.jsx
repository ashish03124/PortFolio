          ...
          <div>
            <div className="flex items-center space-x-4 mb-12">
              <motion.div 
                ...
                viewport={{ once: true }}
                className="h-10 w-2 bg-black dark:bg-demon-red"
              ></motion.div>
              <motion.h2 
                initial={{ opacity: 0, x: -20 }}
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
                className="text-3xl font-extrabold text-black dark:text-white uppercase tracking-wider"
              >
                Experience
              </motion.h2>
            </div>
                ...
                >
                  ...
                  <div className="bg-white dark:bg-white/5 p-6 rounded-none md:rounded-2xl border-2 border-black dark:border-white/5 group-hover:border-black dark:group-hover:border-demon-red/20 transition-all hover:bg-white dark:hover:bg-white/10 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:shadow-none dark:shadow-none">
                    <div className="flex flex-col xl:flex-row justify-between xl:items-start mb-4 gap-2 xl:gap-0">
                      <h3 className="text-2xl md:text-3xl font-black text-black dark:text-white leading-tight">{exp.role}</h3>
            ...
            <div className="space-y-12">
              {education.map((edu, idx) => (
                ...
                >
                  ...
                  <div className="bg-white dark:bg-white/5 p-6 rounded-none md:rounded-2xl border-2 border-black dark:border-white/5 group-hover:border-black dark:group-hover:border-demon-red/20 transition-all hover:bg-white dark:hover:bg-white/10 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:shadow-none dark:shadow-none">
                    <div className="flex flex-col xl:flex-row justify-between xl:items-start mb-4 gap-2 xl:gap-0">
                      <h3 className="text-2xl md:text-3xl font-black text-black dark:text-white leading-tight">{edu.degree}</h3>
