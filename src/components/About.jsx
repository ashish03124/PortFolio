        ...
        <div className="grid md:grid-cols-5 gap-12 lg:gap-24 items-center">
          ...
          >
            ...
            <h3 className="text-3xl md:text-4xl font-black text-black dark:text-white leading-tight">
              A <span className="text-white bg-black dark:bg-demon-red px-2 py-1 transform -rotate-2 inline-block">Data Scientist</span> <br />
              uncovering truth within the chaos of data.
            </h3>
            ...
            <div className="space-y-6">
              <p className="text-gray-700 dark:text-gray-300 leading-[1.8] text-lg font-medium border-l-4 border-black/10 dark:border-white/10 pl-6 italic">
                "I specialize in extracting actionable intelligence from raw data, building predictive models that serve as a guiding flame for strategic decisions."
              </p>
              
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-lg">
                My core expertise lies in <span className="text-black dark:text-white font-bold">Machine Learning, Statistical Modeling, and Big Data Architecture</span>. Beyond the technical, I bring the disciplined mindset of a Hashira to every project—prioritizing clear communication, analytical problem-solving, and collaborative leadership to drive mission success.
              </p>
              
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-lg">
                Whether it's optimizing complex algorithms or presenting data-driven stories to stakeholders, I am committed to <span className="text-black dark:text-white font-bold">accuracy, integrity, and continuous mastery</span> of the analytical elements.
              </p>
            </div>
